                ...
                <xsl:if test="count(help-topic) &gt; 1">
                    ...
                    <table border="0" cellspacing="0" width="100%">
                        <tr class="subheader">
                            ...
                            <td class="subheader-right">
                                <xsl:element name="a">
                                    <xsl:attribute name="href">matlab:<xsl:value-of select="/help-info/help-command-option" /></xsl:attribute>
                                    <xsl:value-of select="/help-info/default-topics-text" />
                                </xsl:element>
                            </td>
                        </tr>
                    </table>
